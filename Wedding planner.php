  ...
  <div class="w3-row">
    ...
    <div class="w3-col m3">
      ...
      <div class="w3-card w3-round w3-white">
        ...
        <h4 class="w3-center">Wedding planner</h4>

         <img src="img/img4.jpg" alt="Wedding planner" width="300" height="300">
    ...
    <?php
                          ...
                          $query = "SELECT * FROM project WHERE category="Wedding planner";
    ...
    <div class="w3-col m2">
      ...
      <div class="w3-card w3-round w3-white w3-center">
        ...
        <div class="w3-container">
          ...
          <p><strong>Wedding planner name </strong></p>
