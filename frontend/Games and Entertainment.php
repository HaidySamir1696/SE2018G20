  ...
  <div class="w3-row">
    ...
    <div class="w3-col m3">
      ...
      <div class="w3-card w3-round w3-white">
        ...
        <h4 class="w3-center">Games and Entertainment</h4>

         <img src="img/img3.jpg" alt="Games and Entertainment" width="300" height="300">
    ...
    <div class="w3-col m2">
      ...
      <div class="w3-card w3-round w3-white w3-center">
        ...
        <div class="w3-container">
          ...
          <p><strong>Games and Entertainment name </strong></p>
