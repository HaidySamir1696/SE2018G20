  ...
  <div class="w3-row">
    ...
    <div class="w3-col m3">
      ...
      <div class="w3-card w3-round w3-white">
        ...
        <h4 class="w3-center">Co-Working spaces</h4>

         <img src="img/co3.jpg" alt="Co-Working spaces" width="300" height="300">
            ...
            <div class="w3-row-padding">
              ...
              <br>
                   ...
                   <div >
                      ...
                      <button type="button" class="w3-button w3-theme-d1 w3-margin-bottom">Â Madenit Nasr</button>

                   </div>

                   <div >

                    <button type="button" class="w3-button w3-theme-d1 w3-margin-bottom">Â Masr El Gdeda</button>
      ...
      <div class="w3-card w3-round w3-white w3-hide-small">
        ...
        <div class="w3-container">
          ...
          <p>
            ...
            <a href="Games and Entertainment.php"><span class="w3-tag w3-small w3-theme-d3">Games and Entertainment</span></a>

            <a href="Wedding planner.php"><span class="w3-tag w3-small w3-theme-d2">Wedding planner</span></a>

            <a href="Co-Working spaces.php"><span class="w3-tag w3-small w3-theme-d1">Co-Working spaces</span></a>
    ...
    <?php
                          ...
                          $query = "SELECT * FROM project WHERE category="Co-Working spaces";
    ...
    <div class="w3-col m7">
      ...
      <div class="w3-container w3-card w3-white w3-round w3-margin"><br>
        ...
        <img src="primary_image/<?php echo $row['primary_image']; ?>"  class="w3-left w3-circle w3-margin-right" style="width:100px">
    ...
    <div class="w3-col m2">
      ...
      <div class="w3-card w3-round w3-white w3-center">
        ...
        <div class="w3-container">
          ...
          <p><strong>Co-Working space name </strong></p>
